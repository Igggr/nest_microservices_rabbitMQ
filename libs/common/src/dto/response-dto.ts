...
export class TokenResponse extends ValueDTO<string> {
  @ApiProperty({
    ...
    example:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IkpvaG5AbWFpbC5jb20iLCJpZCI6MTYsInJvbGVzIjpbIlVTRVIiXSwiaWF0IjoxNjgxMTQyMTUzLCJleHAiOjE2ODEyMjg1NTN9.TrdC0d1LTO7xY-zWuNCZozRXZvqzfb6UDDCbkbq-ANU',
  })
  value: string;
}
...
export const SWAGGER_FORBIDDEN_RESPONSE = {
...
export const SWAGGER_USER_ID_PARAM = {
  name: 'userId',
  description:
    'Id пользователя, должно существовать в БД. Соответсвует user.id (profile.userId), а не его profile.id',
  example: 1,
};
